    ...
    <form id="form1" runat="server">
        <div style="direction:rtl;">
            ...
            <table style="width:50%">
                ...
                <tr>
                    <td colspan="3"><center>
                        <asp:Button ID="ChangePassword" runat="server" Text="שנה" CssClass="form-control btn btn-outline-success" Width="60px" style="margin-right:10px;" />
                        <asp:Button ID="ResetButton" runat="server" Text="אפס" CssClass="form-control btn btn-outline-primary" Width="60px"/></center></td>
                </tr>
            </table>
                </center>
        </div>
